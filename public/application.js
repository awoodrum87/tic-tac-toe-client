...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGameStats = function onGameStats() {
	  event.preventDefault();
	  api.getGame().then(ui.getGameSuccess).catch(ui.getGameFailure);
	};
	...
	// the winner
	var determineWinner = function determineWinner(gameBoard, playerSymbol) {
	  if (gameBoard[0] === playerSymbol && gameBoard[1] === playerSymbol && gameBoard[2] === playerSymbol || gameBoard[3] === playerSymbol && gameBoard[4] === playerSymbol && gameBoard[5] === playerSymbol || gameBoard[6] === playerSymbol && gameBoard[7] === playerSymbol && gameBoard[8] === playerSymbol || gameBoard[6] === playerSymbol && gameBoard[3] === playerSymbol && gameBoard[0] === playerSymbol || gameBoard[7] === playerSymbol && gameBoard[4] === playerSymbol && gameBoard[1] === playerSymbol || gameBoard[8] === playerSymbol && gameBoard[5] === playerSymbol && gameBoard[2] === playerSymbol || gameBoard[6] === playerSymbol && gameBoard[4] === playerSymbol && gameBoard[2] === playerSymbol || gameBoard[8] === playerSymbol && gameBoard[4] === playerSymbol && gameBoard[0] === playerSymbol) {
	    winner = true;
	...
	var onClickBoard = function onClickBoard() {
	  if (keepPlaying === true) {
	    event.preventDefault();
	    if ($(this).text() === ' ') {
	      id = $(this).attr('id');
	...
	var tieGame = function tieGame(moveCount, winner) {
	...
	var stopClicks = function stopClicks() {
	  if (moveCount >= 9) {
	    keepPlaying = false;
	  } else if (winner === true) {
	    keepPlaying = false;
	...
	var updateGame = function updateGame() {
	  api.updateGame(gameData).then(ui.updateGameSuccess).catch(ui.updateGameFailure);
	};
	// click handlers
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signUpSuccess = function signUpSuccess(data) {
	  ...
	  $('#sign-up-message-success').fadeTo(1500, 500).slideUp(500, function () {
	...
	var signUpFailure = function signUpFailure(error) {
	  ...
	  $('#sign-up-message').fadeTo(1500, 500).slideUp(500, function () {
	...
	var signInFailure = function signInFailure(error) {
	  ...
	  $('#sign-in-message').fadeTo(1500, 500).slideUp(500, function () {
	...
	var changePasswordSuccess = function changePasswordSuccess(data) {
	  ...
	  $('#password-message-placeholder-success').fadeTo(1500, 500).slideUp(500, function () {
	...
	var changePasswordFailure = function changePasswordFailure(error) {
	  ...
	  $('#password-message-placeholder-error').fadeTo(1500, 500).slideUp(500, function () {
	...
	var getGameFailure = function getGameFailure(error) {
	  console.error(error);
	};
	module.exports = {
